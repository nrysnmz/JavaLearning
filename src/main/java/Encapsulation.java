...
public class Encapsulation      //The only way to access the data is with methods,no one can use your variables.You encapsulate the variables in the methods,so this is encapsulation.
{
